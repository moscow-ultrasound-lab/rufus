...
void	CFDataPhaseAnalyzerCFM::CalculateMask()
{
	...
	//TODO исключаю временно обозначения мерцания
// 	if(CapsLock())
	{
...
// 	else
// 	{
// 		ApplyMaskCriteriaSet(m_bloodflow_mask, bloodflow_criteria_simple);
// 		m_cavitation_mask.fill(0);
// 		m_oscillation_mask.fill(0);
// 	}
...
{
	XRAD_ASSERT_THROW_M(!conjugated_count(), logic_error, "Function should be called before conjugation")
