...
#include "../ElastoGrafica\ElastoGrafica.h"
...
int run_rufus_elasto(int argc, char** argv)
{
	XRAD_USING

		try {
		ShowText("rufus-elasto", "Elastography mode (not fully integrated yet)");
		return 0;
	}
...
//void rufus_elasto_menu(int, char** const)
